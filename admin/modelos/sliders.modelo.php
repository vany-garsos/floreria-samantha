...
class ModeloSliders{
    /**Mostrar Sliders */
    static public function mdlMostrarSliders($tabla, $item, $campo){
        if ($item != null) {
     ...
     * CREAR Sliders
     */
    static public function mdIgresarSliders($tabla,$parametros){
     ...
     * EDITAR Sliders
     */
    static public function mdIEdtarSliders($tabla, $parametros, $id){
     ...
     * ELIMINAR Sliders
     ...
     static public function MdlEliminarSliders($item, $campo, $tabla){
